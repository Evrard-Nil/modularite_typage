...
public class NatDecimalParIntRecursif extends NombreDecimal implements AlgebreNatRecursif {

	public NatDecimalParIntRecursif(String rep) {
		super(rep);
	}
	...
	public Nat creerNatAvecRepresentation(String repDecimale) {
		...
		return new NatDecimalParIntRecursif(repDecimale);
	}
